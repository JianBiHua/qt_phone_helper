    ...
    ui(new Ui::QuestionDialog)
{
    ...
    ui->pbMin->setStyleSheet (QString("border-image: url(:/images/icon_min.png)"));
    ui->question->setStyleSheet (QString("border-image: url(:/images/question.png)"));
    ...
    ui->nextIcon->setStyleSheet ("border-image: url(:/images/next_icon2.png)");
...
void QuestionDialog::optionGridLayout () {
    const QString texts[] = {"USB连接问题",
                             ...
                             "联系人短信问题",
                             "其他问题及建议"};
    const QString icons[] = {":/images/question_icon1.png",
                            ":/images/question_icon2.png",
                            ":/images/question_icon3.png",
                            ":/images/question_icon1.png",
                            ":/images/question_icon1.png",
                            ":/images/question_icon1.png",
                            ":/images/question_icon1.png",
                            ":/images/question_icon1.png",
    ...
    for(int i=0; i < 3; i++) {
        for(int j = 0; j < 3;j++) {
            ...
            connect (tb, SIGNAL(clicked(bool)), this, SLOT(on_toolbutton_did_clicked(bool)));
        }
    }
}

void QuestionDialog::on_toolbutton_did_clicked(bool b) {
...
void QuestionDialog::optionToolButtons () {
    ...
    ui->nextScreenshot->setIcon (QIcon (":/images/next_tb_1.png"));
    ...
    ui->nextPhoto->setIcon (QIcon (":/images/next_tb_2.png"));
    ...
    ui->nextAnnex->setIcon (QIcon (":/images/next_tb_3.png"));
    ...
    ui->nextPost->setIcon (QIcon (":/images/next_tb_1.png"));
