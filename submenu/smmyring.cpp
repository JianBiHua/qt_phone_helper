#include "smmyring.h"
#include "ui_smmyring.h"
#include <QLabel>

SMMyRing::SMMyRing(QWidget *parent) :
    SMBase(parent),
    ui(new Ui::SMMyRing)
{
    ui->setupUi(this);
    ...
    //
    connect (PhoneHandler::getInstance (), SIGNAL(onRingsChanged()), this, SLOT(on_rings_changed()));
}
...
void SMMyRing::optionToolButtons () {
    ...
    optionToolButton (ui->tbShezhi,QIcon(":/images/icon_shezhi_s.png"),"设为铃声");
}

void SMMyRing::optionTableWidget () {
    QStringList header;
...
void SMMyRing::on_rings_changed() {
